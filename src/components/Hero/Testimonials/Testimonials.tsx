    ...
    >
      {isNext ? (
        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M28 51.3334C15.1134 51.3334 4.6667 40.8867 4.6667 28.0001C4.6667 15.1134 15.1134 4.66675 28 4.66675C40.8867 4.66675 51.3334 15.1134 51.3334 28.0001C51.3334 40.8867 40.8867 51.3334 28 51.3334Z" stroke="#001522" strokeWidth="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M25.06 36.2365L33.2733 27.9998L25.06 19.7632" stroke="#001522" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>

      ) : (
        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M28 51.3334C40.8867 51.3334 51.3333 40.8867 51.3333 28.0001C51.3333 15.1134 40.8867 4.66675 28 4.66675C15.1134 4.66675 4.66667 15.1134 4.66667 28.0001C4.66667 40.8867 15.1134 51.3334 28 51.3334Z" stroke="#001522" strokeWidth="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M30.94 36.2365L22.7266 27.9998L30.94 19.7632" stroke="#001522" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      )}
    </button>
  );
